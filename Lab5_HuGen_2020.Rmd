...
Use Pipes when applicable in your code and use the common dplyr functions for the exercises
...
SNP_density_table <- SNPs %>% 
  ...
  mutate(SNP_density = (max_position - min_position) / n) %>% 
  arrange(SNP_density)
write_csv(SNP_density_table, path = "data/SNP_density_table.csv")
```
